...
## Fork Changes (kwgch/claude-code-action@beta)
...
- **Updated Base Action**: Uses `kwgch/claude-code-base-action@beta` which includes OAuth credential handling
...
3. Enable OAuth in your workflow:
   ```yaml
   - uses: kwgch/claude-code-action@beta
     with:
       use_oauth: "true"
